          ...
          <div className="flex flex-col gap-3 w-full sm:w-full md:w-[50%] mx-5 sm:mx-5 md:mx-0">
            <div className="text-lg font-bold tracking-wider text-center">
              <div className="flex justify-center items-center gap-1 text-[#1c59ba]">
                ...
                <span className="text-[17px] font-semibold">Signup</span>
              </div>
            </div>
            <div className="flex flex-col">
              ...
              {formik.errors && formik.touched.first_name ? (
                <div className="text-[#D63301]">{formik.errors.first_name}</div>
              ) : (
                ""
              )}
            </div>
            <div className="flex flex-col">
              ...
              {formik.errors && formik.touched.last_name ? (
                <div className="text-[#D63301]">{formik.errors.last_name}</div>
              ) : (
                ""
              )}
            </div>
            <div className="flex flex-col">
              ...
              {formik.errors && formik.touched.email ? (
                <div className="text-[#D63301]">{formik.errors.email}</div>
              ) : (
                ""
              )}
            </div>
            ...
            <div className="flex flex-col relative">
              <label className="font-semibold text-[16px] rounded">
                Password
              </label>
              <div className="relative">
                ...
                {formik.errors && formik.touched.password ? (
                  <div className="text-[#D63301] absolute">
            ...
            <div className="flex flex-col relative">
              ...
              <div className="relative">
                ...
                {formik.errors && formik.touched.confirm_password ? (
                  <div className="text-[#D63301] absolute">
            ...
            <Link to={"/login"}>
              <p className="text-[#1c59ba] text-[17px] font-semibold underline">Do you have already an account?</p>
              </Link>
            <button
            type="button"
              onClick={formik.handleSubmit}
              className={loading?"bg-[#1c59ba] px-3 py-2 text-white font-bold mt-5 flex justify-center items-center gap-1 opacity-[0.5]":"bg-[#1c59ba] px-3 py-2 text-white font-bold mt-5 flex justify-center items-center gap-1"}
            >
              <span className="relative top-[2px]">
                <MdOutlineAccountCircle size={25} />
              </span>
